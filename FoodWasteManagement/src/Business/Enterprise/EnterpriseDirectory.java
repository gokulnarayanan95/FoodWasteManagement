...
public class EnterpriseDirectory {
    ...
    public Enterprise createAndAddEnterPrise(String name, Enterprise.EnterpriseType type) //create and adding enterprise
    {
        ...
        {
            enterprise = new NetworkManagementEnterprise(name);
            enterpriseList.add(enterprise);
        }
