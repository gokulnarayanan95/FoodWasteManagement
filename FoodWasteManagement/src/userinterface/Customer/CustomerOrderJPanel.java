...
private Ecosystem system;
     ...
     */
    public CustomerOrderJPanel(JPanel userProcessContainer,Ecosystem system, Customer c) {
        initComponents();
    ...
    public void populateCombo(){                 //populate restaurant combo box
        ...
        public void refreshOrderTable(){             //refresh table
        ...
        try{    int salesPrice=(int) tb1.getValueAt(selectedRow,3);
                ...
                for(OrderItem oi : order.getOrderItemList()){
                    if(oi.getFoodItem()== selectedProduct){
                        ...
                        oi.setSalesPrice(salesPrice*(fetchQty+oi.getQuantity()));
                        alreadyPresent = true;
                ...
                if(!alreadyPresent){
                    order.addOrderItem(selectedProduct, fetchQty, (int) salesPrice*fetchQty);
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        ...
        if(order.getOrderItemList().size()>0)
        {
         //   system.getMoc().appendOrder(order);
            ...
            request.getOrder().setCustomer(customer);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ViewOrderHistory panel = new ViewOrderHistory(userProcessContainer,  system, customer);
        userProcessContainer.add("ViewOrderHistory", panel);
