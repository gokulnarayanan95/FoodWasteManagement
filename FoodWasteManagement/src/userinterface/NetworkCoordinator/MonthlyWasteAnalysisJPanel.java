...
public class MonthlyWasteAnalysisJPanel extends javax.swing.JPanel {
     ...
     */
    public MonthlyWasteAnalysisJPanel(JPanel userProcessContainer, Network network) {
    ...
    private void initUI() {
      ...
      private XYDataset createDataset() {
        ...
        network.getReport().setMonthly_waste("The month with maximum donations is "+toMonthName(max_index)+"With a total donation value of "+max 
        +"\n The month with minimum donation is "+toMonthName(min_index)+" with a total donation value of  "+min);
