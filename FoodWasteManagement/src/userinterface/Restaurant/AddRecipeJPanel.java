...
public class AddRecipeJPanel extends javax.swing.JPanel {
   ...
   public AddRecipeJPanel(JPanel userProcessContainer, FoodItem foodItem, RestaurantEnterprise restaurantEnterprise, Ecosystem system, Network network) {
        initComponents();
   ...
   public void PopulateCombo2(){              //populate raw material combo box
   ...
   public void populateTable(){                  //populate table
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        int Quantity  = Integer.parseInt(txtQuantity.getText());
         if(txtQuantity.getText().equals("") || !(txtQuantity.getText().matches("[0-9]+")))
         {
